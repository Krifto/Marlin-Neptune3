...
#define STRING_CONFIG_H_AUTHOR "(Krifto, enable some advanced features)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki  1.80 // 1.80
    #define DEFAULT_Kd  79.42// 79.42 
  #endif
#endif // PIDTEMP
 ...
 */
#define PIDTEMPBED          //3--------开启热床PID="Turn on the hot bed PID"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 113.97
  #define DEFAULT_bedKi  16.37
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 138.2 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 6, 60 }    //1------最高速度="Maximum speed"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 800, 100, 1000 }     //1------最高加速度="Highest acceleration"
